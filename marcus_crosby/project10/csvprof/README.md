# csvprof Part 2: Baltimore Data Correlation + WASM
...
![](/output/top_neighborhood_crime.svg)
...
Build the browser WebAssembly bundle and serve the static UI:
...
Then open <http://localhost:8080>. The browser app loads
`web/pkg/csvprof.wasm` and runs the same streaming profiler locally in the
browser.
